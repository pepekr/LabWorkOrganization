...
namespace LabWorkOrganization.Domain.Entities
{
    public class User
    {
        ...
        [JsonIgnore] public ICollection<SubGroup> SubGroups { get; set; } = new List<SubGroup>();

        [JsonIgnore] public ICollection<ExternalToken> ExternalTokens { get; set; } = new List<ExternalToken>();
    }
}
